...
def test_cadastro_email_invalido(driver):
    ...
    preencher_formulario(driver, "Usuário", "123.456.789-09", "(75) 91234-5678", "invalido@email@", "12345678", "12345678")
    assert "email" in driver.page_source.lower()

def test_cadastro_senhas_diferentes(driver):
    acessar_formulario_cadastro(driver)
    preencher_formulario(driver, "Usuário", "123.456.789-09", "(75) 91234-5678", "teste@exemplo.com", "Senha123", "Senha456")
    assert "iguais" in driver.page_source.lower() or "confirmar" in driver.page_source.lower()

def test_cadastro_senha_curta(driver):
    acessar_formulario_cadastro(driver)
    preencher_formulario(driver, "Usuário", "123.456.789-09", "(75) 91234-5678", "teste@exemplo.com", "1234567", "1234567")
    assert "senha" in driver.page_source.lower()

def test_cadastro_telefone_invalido(driver):
    acessar_formulario_cadastro(driver)
    preencher_formulario(driver, "Usuário", "123.456.789-09", "(75) 1234-5678", "teste@exemplo.com", "12345678", "12345678")
    assert "telefone" in driver.page_source.lower()

def test_cadastro_cpf_invalido(driver):
    acessar_formulario_cadastro(driver)
    preencher_formulario(driver, "Usuário", "123.456.789-00", "(75) 91234-5678", "teste@exemplo.com", "12345678", "12345678")
    assert "cpf" in driver.page_source.lower()

def test_cadastro_valido(driver):
    acessar_formulario_cadastro(driver)
    preencher_formulario(driver, "Usuário", "123.456.789-09", "(75) 91234-5678", "teste@exemplo.com", "12345678", "12345678")
